      ...
      <section className="relative h-[600px] flex items-center justify-center overflow-hidden">
        ...
        <Container className="relative z-10 text-center">
          <h1 className="font-display font-bold text-5xl md:text-7xl text-white mb-6 animate-fade-in inline-block">
            Lộc bếp Việt <br />
            <span className="text-gold-300 block mt-4">
              Bao lì xì ẩm thực Việt
            </span>
          </h1>
          <p className="text-primary-100 text-lg md:text-xl max-w-2xl mx-auto mb-10 animate-slide-up opacity-90">
            Bộ sưu tập bao lì xì độc quyền 2026. Thiết kế tinh tế, chất liệu cao
            cấp, mang may mắn đến mọi nhà.
          </p>
          <div className="flex justify-center gap-4 animate-slide-up delay-100">
            <Link
              href="/products"
              className="px-8 py-3 bg-gold-400 hover:bg-gold-500 text-primary-950 font-bold rounded-full transition-all hover:shadow-lg hover:-translate-y-1"
            >
              Xem Bộ Sưu Tập
            </Link>
            <Link
              href="/about"
              className="px-8 py-3 bg-white/10 hover:bg-white/20 text-white font-semibold rounded-full backdrop-blur-sm transition-all"
            >
              Tìm Hiểu Thêm
            </Link>
          </div>
                ...
                >
                  <div className="relative aspect-[3/4] bg-gray-100 rounded-2xl overflow-hidden mb-4 border border-gray-100 shadow-sm transition-all group-hover:shadow-xl group-hover:-translate-y-2">
                    <Image
                      src={
                        product.images?.[0] ||
                        "https://placehold.co/400x600/red/gold.png?text=Lì+Xì"
                      }
                      alt={product.name}
                      fill
                      className="object-cover"
