                ...
                <div className="max-w-4xl mx-auto space-y-24">
                    ...
                    <div className="space-y-8">
                        <div className="text-center">
                            <h1 className="font-display font-bold text-4xl md:text-5xl text-gray-900 mb-6">Câu Chuyện Lì Xì 2025</h1>
                        ...
                        <div className="prose prose-lg prose-stone max-w-none text-gray-600 leading-relaxed text-center">
                            ...
                            <p>
                                Dự án **Lì Xì 2025** được thành lập với mong muốn gìn giữ nét văn hóa truyền thống của người Việt thông qua những phong bao lì xì được thiết kế hiện đại, tinh tế. Mỗi sản phẩm là tâm huyết của đội ngũ sáng tạo, gửi gắm những giá trị tinh thần tốt đẹp cho ngày Tết Việt Nam.
                            </p>
                        </div>
                    </div>
