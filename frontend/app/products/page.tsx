        ...
        <Container>
          <div className="mb-12 text-center">
            ...
            <p className="text-gray-500 max-w-2xl mx-auto">
              Tổng hợp các mẫu bao lì xì được thiết kế tỉ mỉ, ép kim sang trọng,
              mang lại may mắn và tài lộc cho năm mới.
            </p>
          </div>
              ...
              <div className="bg-white rounded-2xl overflow-hidden shadow-sm border border-gray-100 transition-all hover:shadow-xl hover:-translate-y-1">
                <div className="relative aspect-[3/4] bg-gray-100">
                  <Image
                    src={
                      product.images?.[0] ||
                      "https://placehold.co/400x600/red/gold.png?text=No+Image"
                    }
                    alt={product.name}
                    fill
